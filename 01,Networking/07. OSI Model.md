...
### TCP 3 way handshake
==3-way handshake is the process used by TCP to establish a reliable connection between client and server before data transfer.==

**Before sending data:**
- Both sides must agree to communicate
...
==The Physical Layer is responsible for transmitting raw bits (0s and 1s) over a physical medium or Wireless Medium.==
