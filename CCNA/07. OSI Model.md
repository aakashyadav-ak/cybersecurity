...
|      └── Scrambles data so hackers can't read            |
|      └── "Hello" becomes "x8K#mP2$"                      |
|                                                          |
|   2. AUTHENTICATION (Identity)                           |
|      └── Proves website is real (not fake)               |
|      └── Certificate = Website's ID card                 |
|                                                          |
|   3. INTEGRITY (No tampering)                            |
|      └── Ensures data is not modified                    |
|      └── Detects if someone changed the message          |
|                                                          |
+----------------------------------------------------------+
```
...
│  │              │ - VPN protocol                                  ││
│  │              │ - Creates tunnels for PPP traffic               ││
│  ├──────────────┼─────────────────────────────────────────────────┤│
│  │ SCP          │ Session Control Protocol                        ││
│  │              │ - SIP session management                        ││
│  ├──────────────┼─────────────────────────────────────────────────┤│
│  │ PAP          │ Password Authentication Protocol                ││
│  │              │ - Simple authentication (plaintext!)            ││
│  ├──────────────┼─────────────────────────────────────────────────┤│
