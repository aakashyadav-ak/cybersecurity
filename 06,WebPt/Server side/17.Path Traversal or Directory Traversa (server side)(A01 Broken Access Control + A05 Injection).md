...
- Absolute paths are often seen in error messages → can leak server structure (info disclosure).[[04.Information disclosure (A02 Security Misconfiguration + A10 Mishandling Exceptional Conditions)]] 
